...
int main(int argc, char** argv) {
   ...
   string trained_classifier_location = "/home/nathan/Downloads/opencv/samples/winrt_universal/VideoCaptureXAML/video_capture_xaml/video_capture_xaml.Windows/Assets/haarcascade_frontalface_alt.xml";//Defining the location our XML Trained Classifier in a string//
